...
class InteractiveRecord
    ...
    #Self in the instance method bellow refers to an instance of the class and not class itself.

    def table_name_for_insert
        self.class.table_name
    end

    #SQL already makes a unique ID so we have to remove the "ID" portion from our column name method.
